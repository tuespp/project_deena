                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="insurance_insert_form.php" style="text-transform: uppercase">เพื่มรายการ</a></li>
                            <li class="breadcrumb-item active" style="text-transform: uppercase">เพื่มรายการ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
