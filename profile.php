          ...
          <?php
             if($_SESSION['level'] == 'admin') {
              ...
              $result_array=array_search("admin",$profile); //array
                ...
                echo " <li class='nav-item'><a href='profile.php' class='nav-link active'>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item" style="text-transform: uppercase"><a href="member_index.php"><?php echo $row['level']; ?> profile</a></li>
