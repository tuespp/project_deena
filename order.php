                      ...
                      <p>
                       Shop Info
                        ...
                        if ($_SESSION['level'] == 'admin') {
                            ...
                            if ($result_array !== false) {
                                echo " <li class='nav-item'><a href='order.php' class='nav-link active'>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="text-transform: uppercase">orders</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="control.php" style="text-transform: uppercase">orders</a></li>
                                <li class="breadcrumb-item active" style="text-transform: uppercase">orders</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
