                ...
                <p>
                  Profile
                        ...
                        if ($_SESSION['level'] == 'admin') {
                            ...
                            if ($result_array !== false) {
                                echo " <li class='nav-item'><a href='control.php' class='nav-link active'>
                    ...
                    <p>
                      ...
                      <p>
                        ...
                        if ($_SESSION['level'] == 'admin') {
                            ...
                            if ($result_array !== false) {
                                echo " <li class='nav-item'><a href='shopinfo.php' class='nav-link '>
                                            ...
                                            <tbody>
                                                <div class="form-group">
                                                    <tr>
                                                        ...
                                                        <?php
                                                        $profile = explode(",", $rowc['profile']); //array
                                                        foreach ($profile_arr as $value) {
                                                            if (in_array($value, $profile)) {
                                                                echo " <td><input type='checkbox' name='profile[]' value='$value' checked></td>";
                                                                echo " <input type='hidden' name='profile[]' value='0'>";
                                                            } else {
                                                                echo " <td><input type='checkbox' name='profile[]' value='$value' ></td>";
                                                            }
                                                        }
                                                        ?>
                                                    </tr>
                                                ...
                                                <div class="form-group">
                                                    <tr>
                                                        <td>2</td>
                                                        <td><label for="control">Control Setting</label>
                                                        </td>
                                                        <?php
                                                        $control = explode(",", $rowc['control']); //array
                                                        foreach ($control_arr as $value) {
                                                            if (in_array($value, $control)) {
                                                                echo " <td><input type='checkbox' name='control[]' value='$value' checked></td>";
                                                                echo " <input type='hidden' name='control[]' value='0'>";
                                                            } else {
                                                                echo " <td><input type='checkbox' name='control[]' value='$value' ></td>";
                                                            }
                                                        }
                                                        ?>
                                                    </tr>
                                                ...
                                                <div class="form-group">
                                                    <tr>
                                                        <td>3</td>
                                                        <td><label for="order">Orders</label>
                                                        </td>
                                                        <?php
                                                        $order = explode(",", $rowc['order']); //array
                                                        foreach ($order_arr as $value) {
                                                            if (in_array($value, $order)) {
                                                                echo " <td><input type='checkbox' name='order[]' value='$value' checked></td>";
                                                                echo " <input type='hidden' name='order[] value='0'>";
                                                            } else {
                                                                echo " <td><input type='checkbox' name='order[]' value='$value' ></td>";
                                                            }
                                                        }
                                                        ?>
                                                    </tr>
                                                ...
                                                <div class="form-group">
                                                    <tr>
                                                        <td>4</td>
                                                        <td><label for="purchase">Purchasing</label>
                                                        </td>
                                                        <?php
                                                        $purchase = explode(",", $rowc['purchase']); //array
                                                        foreach ($purchase_arr as $value) {
                                                            if (in_array($value, $purchase)) {
                                                                echo " <td><input type='checkbox' name='purchase[]' value='$value' checked></td>";
                                                                echo " <input type='hidden' name='purchase[] value='0'>";
                                                            } else {
                                                                echo " <td><input type='checkbox' name='purchase[]' value='$value' ></td>";
                                                            }
                                                        }
                                                        ?>
                                                    </tr>
                                                ...
                                                <div class="form-group">
                                                    <tr>
                                                        <td>5</td>
                                                        <td><label for="shopinfo">Shop Info</label> </td>
                                                        <?php
                                                        $shopinfo = explode(",", $rowc['shopinfo']); //array
                                                        foreach ($shopinfo_arr as $value) {
                                                            if (in_array($value, $shopinfo)) {
                                                                echo " <td><input type='checkbox' name='shopinfo[]' value='$value' checked></td>";
                                                                echo " <input type='hidden' name='shopinfo[] value='0'>";
                                                            } else {
                                                                echo " <td><input type='checkbox' name='shopinfo[]' value='$value' ></td>";
                                                            }
                                                        }
                                                        ?>
                                                    </tr>
                                                    <input type="submit" class="btn btn-warning m-auto " value="Save Data">
                                                </div>
                                                </tfoot>
                                        </table>
                            </form>
